...
@Tag(name = "Pagos", description = "Endpoints para el procesamiento de compras de juegos")
public class PagosController {
    ...
    @PostMapping("/comprar")
    @Operation(summary = "Procesar compra", description = "Procesa el pago de los juegos seleccionados por el usuario.")
